	...
	acf_add_local_field_group(
		array(
			...
			'fields'   => array(
				...
				array(
					'key'     => 'field_hvac_ct_business_note',
					'label'   => esc_html__('Phone, Email, Address, Hours & Social Links', 'hvac'),
					'type'    => 'message',
					'message' => esc_html__('Managed under Theme Options > Business Info, so the same details stay in sync across this page, the header, and the footer.', 'hvac'),
				),
