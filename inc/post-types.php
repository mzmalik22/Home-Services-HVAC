	...
	acf_add_local_field_group(
		array(
			...
			'fields'   => array(
				...
				array(
					'key'          => 'field_hvac_sd_reviews',
					'label'        => esc_html__('Reviews', 'hvac'),
					'name'         => 'reviews',
					'type'         => 'repeater',
					'layout'       => 'block',
					'button_label' => esc_html__('Add Review', 'hvac'),
					'instructions' => esc_html__('Leave empty to use sample reviews.', 'hvac'),
					'sub_fields'   => array(
						array(
							'key'           => 'field_hvac_sd_review_image',
							'label'         => esc_html__('Card Image', 'hvac'),
							'name'          => 'image',
							'type'          => 'image',
							'return_format' => 'array',
							'preview_size'  => 'medium',
							'instructions'  => esc_html__('Wide image shown at the top of the card.', 'hvac'),
						),
						array(
							'key'           => 'field_hvac_sd_review_headshot',
						...
						array(
							'key'   => 'field_hvac_sd_review_quote',
						...
						array(
							'key'   => 'field_hvac_sd_review_name',
							'label' => esc_html__('Name', 'hvac'),
							'name'  => 'name',
							'type'  => 'text',
						),
						array(
							'key'   => 'field_hvac_sd_review_role',
							'label' => esc_html__('Role', 'hvac'),
							'name'  => 'role',
							'type'  => 'text',
						),
						array(
							'key'           => 'field_hvac_sd_review_rating',
